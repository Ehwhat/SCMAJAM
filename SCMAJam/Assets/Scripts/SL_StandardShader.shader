    ...
    SubShader
    {
        ...
        {    
            ...
            float4 frag(VertexOutput input) : COLOR
            {
				...
				fixed4 tint = tex2D(_TintMap, (input.posWorld.xy / _TintMapSize) + .5);
                ambientResult = float4(ambientColour * diffuseColour + float4(emissiveColour * _EmissiveStrength, 0.0)) * tint;
                ...
                float4 finalColour = float4(diffuseReflection + specularReflection, diffuseColour.a * _TintColor.a) + ambientResult * _TintColor.a;
